...
a persistence unit "ExamenPaltaRaynerServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenPaltaRaynerServidor\pom.xml":
...
artifact ("ExamenPaltaRaynerServidor.war") is already built. You can build
